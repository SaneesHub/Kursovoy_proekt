...
@section('title', 'Интернет-услуги')

@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Интернет-тарифы</h1>
            ...
            @endphp
                <div class="service-card service-card--internet">
                    <div class="service-card__header">
                        ...
                        <span class="service-card__type">Интернет</span>
                    </div>
                    
                    <div class="service-card__body">
                        <p class="service-card__description">Высокоскоростной доступ в интернет с гарантированной скоростью</p>
